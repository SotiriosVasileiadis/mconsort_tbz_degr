...
class Config:
    GENOME_FASTA = "3_final_rnmd_frmtd.fasta"
    ...
    FEATURE_ADJUSTMENT = {
        ...
        "merge_cds": True,  # True: enabled, False: disabled
    ...
    FUNCTIONAL_ANNOTATION = [
        ...
        },
        {
            ...
            "options": {
                ...
                "evalue_cutoff": 1e-6,
                "db_name": "Pfam",
                "database": "@@APP_ROOT@@/db/hmm/Pfam-A.hmm",
            },
        },
        {
            # You can add another HMMscan, if you want.
            ...
            "options": {
                ...
                "evalue_cutoff": 1e-6,
                "db_name": "dbCAN",
                "database": "@@APP_ROOT@@/db/hmm/dbCAN-fam-HMMs.txt",
            },
        },
        {
